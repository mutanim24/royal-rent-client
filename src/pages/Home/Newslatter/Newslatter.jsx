...
const Newslatter = () => {
    return (
        <div className='text-center p-20 border w-8/12 mx-auto'>
            <h2 className='text-3xl mb-3 font-bold'>Accelerate Your Savings with Our Exclusive Offers!</h2>
            <p>Sign up for our newsletter to receive insider access to limited-time promotions and unbeatable car rental deals.</p>
            <div>
